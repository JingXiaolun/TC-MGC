...
class LSMDC_DataLoader(Dataset):
    ...
    def __init__(
        ...
        video_json_path_dict["train"] = os.path.join(self.data_path, "LSMDC16_annos_training.csv")  # 101079
        video_json_path_dict["val"] = os.path.join(self.data_path, "LSMDC16_annos_val.csv")  # 7408
        video_json_path_dict["test"] = os.path.join(self.data_path, "LSMDC16_challenge_1000_publictect.csv")  # 1000
        #video_json_path_dict["test"] = os.path.join(self.data_path, "LSMDC16_annos_test.csv")  # 10053
        ...
        with open(video_json_path_dict[self.subset], 'r') as fp:
            for line in fp:
                ...
                caption_dict[len(caption_dict)] = (clip_id, sentence) # 101079
                if clip_id not in video_id_list: 
                    video_id_list.append(clip_id)  # 101046
        ...
        self.video_dict = video_dict  # 101046
        ...
        for clip_id, sentence in caption_dict.values():
            if clip_id not in self.video_dict:
                continue
            self.iter2video_pairs_dict[len(self.iter2video_pairs_dict)] = (clip_id, sentence) # 101079
