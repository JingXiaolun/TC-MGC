...
class ActivityNet_DataLoader(Dataset):
    def __init__(
        ...
        video_id_path_dict = {}
        video_id_path_dict["train"] = os.path.join(self.data_path, "train_ids.json") # 10024
        video_id_path_dict["val"] = os.path.join(self.data_path, "val_ids.json") # 4926

        video_json_path_dict = {}
        video_json_path_dict["train"] = os.path.join(self.data_path, "train.json") # 10009
        video_json_path_dict["val"] = os.path.join(self.data_path, "val_1.json") # 4917
    ...
    def _get_rawvideo(self, idx, s, e):
        ...
        #video_path_npz = video_path.replace('split_video', 'clip4clip_video_frame_input') + 'npz'
        try:
